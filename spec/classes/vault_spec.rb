...
describe 'vault' do
  on_supported_os.each do |osfamily, fact_hash|
    describe osfamily do
      ...
      context "service with modified options", :if => fact_hash[:osfamily] == 'Debian' do
        let(:params) { {
          :bin_dir         => '/opt/bin',
